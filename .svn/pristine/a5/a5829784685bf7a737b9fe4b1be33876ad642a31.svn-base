...
return array (
  ...
  'ADMIN_STATISTICS_CONSULT_TASK_TYPE' => '任务类型统计',
  'ADMIN_STORAGE_INDEX' => '文件存储',
  'ADMIN_STORAGE_SETTING_POST' => '文件存储设置提交',
  'ADMIN_TASK_TASK_LIST' => '任务列表',
  'ADMIN_USER_ADD_POST' => '添加提交',
  'ADMIN_USER_BAN' => '禁用管理员',
  'ADMIN_USER_CANCELBAN' => '启用管理员',
  'ADMIN_USER_EDIT_POST' => '编辑提交',
  'ADMIN_USER_INDEX' => '系统管理员',
  'ADMIN_USER_USERINFO' => '修改信息',
  'ADMIN_USER_USERINFO_POST' => '修改信息提交',
  'ADMIN_ACCOUNT_CITY_ACCOUNT_INDEX' => '市级账户',
  'ADMIN_INDEX_INDEX' => '账户管理',
  'ADMIN_SETTING_CLEARCACHE' => '清除缓存',
  'ADMIN_STATISTICS_ACCOUNT_TYPE' => '账户类型',
  'ADMIN_ACCOUNT_COUNTY_ACCOUNT_INDEX' => '区县账户',
  'ADMIN_ACTIVITY_ACTIVITY_MSG' => '活动通知管理',
  'ADMIN_STATISTICS_MONTH_CONSULT_TASK' => '月度任务统计',
  'ADMIN_ACCOUNT_CONTACT_ACCOUNT_INDEX' => '相关账户',
  'ADMIN_STATISTICS_EXPERT_TYPE' => '咨询类型统计',
  'ADMIN_STATISTICS_INDEX' => '统计管理',
  'ADMIN_ACCOUNT_EXPERT_ACCOUNT_INDEX' => '专家账户',
  'ADMIN_TASK_INDEX' => '任务管理',
